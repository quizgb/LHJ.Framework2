...
namespace LHJ.Common.Control.Toast
{
    public partial class frmNotify : Form
    {
        ...
        public frmNotify(string title, string text) : this() { Title = title; Text = text; }
        /// <param name="text">Text displayed in the NotifyWindow</param>
        public frmNotify(string text) : this() { Text = text; }
        public frmNotify()
        {
        ...
        public void Notify()
        {
            ...
            SoundPlayer player = new SoundPlayer(Properties.Resources.recv_mail);
            player.Play();
        }
        #endregion
